				...
				<table width="100%" border="0" align="center" class="bordatabela">
					...
					<tr class="fundoclaro">
						...
						<td width="88%" align="left" colspan="3">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.login" styleClass="inputconsultar" size="20" maxlength="20"/>
						</td>
					</tr>
					<tr class="fundoclaro">
						<td width="22%" align="center">Senha</td>
						<td width="78%" align="left" colspan="3">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.senha" styleClass="inputconsultar" size="20" maxlength="20"/>
						</td>
					</tr>
					<tr class="fundoclaro">
						...
						<td align="left" colspan="3" width="78%">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.email" styleClass="inputconsultar" size="30" maxlength="20"/>
						</td>
					</tr>
					...
					<tr class="fundoclaro">
						...
						<td align="left" width="78%" colspan="3">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.enderecoVO.logradouro" styleClass="inputconsultar" size="90" maxlength="70"/>
						</td>
					</tr>
					<tr class="fundoclaro">
						...
						<td align="left" width="28%">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.enderecoVO.numero" styleClass="inputconsultar" size="5" maxlength="10"/>
						</td>
						<td align="center" width="18%">Complemento</td>
						<td align="left" width="32%%">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.enderecoVO.complemento" styleClass="inputconsultar" size="30" maxlength="20"/>
						</td>
					</tr>
					<tr class="fundoclaro">
						<td align="center" width="22%">Bairro</td>
						<td align="left" width="28%">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.enderecoVO.bairro" styleClass="inputconsultar" size="20" maxlength="30"/>
						</td>
						<td align="center" width="18%">Cidade</td>
						<td align="left" width="32%%">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.enderecoVO.cidade" styleClass="inputconsultar" size="20" maxlength="30"/>
						</td>
					</tr>
					<tr class="fundoclaro">
						<td align="center" width="22%">Estado</td>
						<td align="left" width="78%" colspan="3">
							<html:text disabled="true" name="manterJuridicaForm" property="juridicaVO.clienteVO.enderecoVO.estado" styleClass="inputconsultar" size="5" maxlength="30"/>
						</td>
					</tr>
