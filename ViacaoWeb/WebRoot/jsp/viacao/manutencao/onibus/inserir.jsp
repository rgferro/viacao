			...
			<jsp:include page="/jsp/common/mensagens.jsp" />
				...
				<table width="100%" border="0" align="center">
					<tr>
						...
						<td align="center">
							<c:if test="${manterOnibusForm.acao eq 'ALTERAR'}">
								<html:button value="Confirmar" property="" styleClass="botao" onclick="confirmar('ALTERAR');"/>
							</c:if>
							<c:if test="${manterOnibusForm.acao ne 'ALTERAR'}">
								<html:button value="Cadastrar" property="" styleClass="botao" onclick="confirmar('CADASTRAR');"/>
							</c:if>
						</td>
						<td align="center">
